...
const createSiteBoardTaskMarkup = () => {
  return (
    `
...
const createSiteLoadMoreMarkup = () => {
  return (
    `
...
const createSiteCardEditMarkup = () => {
  return (
    `
      <article class="card card--edit card--black">
            <form class="card__form" method="get">
              <div class="card__inner">
                ...
                <div class="card__textarea-wrap">
                  <label>
                    <textarea class="card__text" placeholder="Start typing your text here..." name="text">This is example of new task. You can set date and chose repeating days and color.</textarea>
                  </label>
                </div>
